...
public class ExecutePreparedSqlSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public ExecutePreparedSqlSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ExecutePreparedSqlSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
