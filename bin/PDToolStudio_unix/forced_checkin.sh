...
#  # forced_checkin.sh [CIS-resource-path] [CIS-resource-type] [message] [vcs-workspace-project-folder] [vcs-temp-folder]
#  # 
#  # Parameters
#  # ----------
...
#  #***********************************************
JAVA_ACTION=vcsStudioForcedCheckin
