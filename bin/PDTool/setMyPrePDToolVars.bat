...
REM #
REM ################################
REM # COMPOSITE SERVER VARIABLES
REM ################################
REM # 0=Do not print this section, 1=Print this section
set CIS_PRINT=1
REM # CIS Port - Used to define the SERVERID in deploy.properties
set CIS_PORT=
...
REM # This is used in DataSourceModule.xml for updating the URL for the web service data source.
set CIS_WSPORT=
REM # Composite Server Username
set CIS_USERNAME=
REM # Composite Server Password
set CIS_PASSWORD=
REM # Composite Server Domain
set CIS_DOMAIN=
REM #
REM ################################
REM # TFS VARIABLES
...
REM # The TFS folder path starting at the TFS project and ending where the Composite base level root folders start
...
REM # The Subversion folder path starting directly after the Subversion repo URL and ending where the Composite base level root folders start
...
set MSG=!MSG!------------------!LF!
set MSG=!MSG!CIS_PORT                   =%CIS_PORT%!LF!
set MSG=!MSG!CIS_HTTP_TYPE              =%CIS_HTTP_TYPE%!LF!
set MSG=!MSG!CIS_WSPORT                 =%CIS_WSPORT%!LF!
...
set MSG=!MSG!TFS_VCS_HOST               =%TFS_VCS_HOST%!LF!
...
set MSG=!MSG!SVN_VCS_HOST               =%SVN_VCS_HOST%!LF!
...
set MSG=!MSG!P4_VCS_HOST                =%P4_VCS_HOST%!LF!
...
set MSG=!MSG!CVS_VCS_HOST               =%CVS_VCS_HOST%!LF!
