...
REM #=======================================
set DEPLOY_CLASSPATH="@DEPLOY_CLASSPATH@"
...
:: -------------------------------------------------------------
	...
	call %writeOutput% " "
	call %writeOutput% "            Example: %SCRIPT%%ext% -exec ../resources/properties/myplan.dp -vcsuser user -vcspassword password -config deploy.properties -release 20141201 -ver @version@"
	call %writeOutput% " "
	...
	call %writeOutput% "               arg10-11::[-ver @version@] optional parameter used to specify the version of CIS to connect to.
	call %writeOutput% " -----------------------------------------------------------------------------------------------------"
	...
	call %writeOutput% " "
	call %writeOutput% "            Example: %SCRIPT%%ext% -ant ../resources/ant/build.xml -vcsuser user -vcspassword password -config deploy.properties -release 20141201 -ver @version@"
	call %writeOutput% " "
