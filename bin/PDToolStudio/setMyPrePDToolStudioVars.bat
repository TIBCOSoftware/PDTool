...
REM # Set the VCS Workspace name which may be different for each configuration above.
set MY_VCS_WORKSPACE_NAME=
REM #
REM ################################
REM # TFS VARIABLES
REM ################################
...
set MSG=!MSG!MY_VCS_WORKSPACE_NAME     =%MY_VCS_WORKSPACE_NAME%!LF!
)
if %TFS_PRINT%==1 (
set MSG=!MSG!------------------!LF!
