...
import com.compositesw.services.system.admin.resource.DesignProcedureByExampleRequest;
...
import com.compositesw.services.system.util.security.GetSystemEncryptionRequest;
...
import com.compositesw.services.system.util.security.UpdateSystemEncryptionRequest;
...
@XmlSeeAlso({
    ...
    DesignProcedureByExampleRequest.class,
    ...
    GetSystemEncryptionRequest.class,
    ...
    UpdateSystemEncryptionRequest.class,
