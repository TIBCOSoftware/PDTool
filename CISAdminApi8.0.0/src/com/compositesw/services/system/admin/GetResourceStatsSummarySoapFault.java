...
public class GetResourceStatsSummarySoapFault
    extends Exception
{
     ...
     * @param message
     */
    public GetResourceStatsSummarySoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetResourceStatsSummarySoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
