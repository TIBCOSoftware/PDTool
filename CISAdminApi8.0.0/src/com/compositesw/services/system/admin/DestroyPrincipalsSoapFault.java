...
public class DestroyPrincipalsSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public DestroyPrincipalsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public DestroyPrincipalsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
