...
public class DesignProcedureByExampleSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public DesignProcedureByExampleSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public DesignProcedureByExampleSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
