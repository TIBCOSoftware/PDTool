 ...
 * 
 */
@WebServiceClient(name = "user", targetNamespace = "http://www.compositesw.com/services/system/admin", wsdlLocation = "file:/C:/MyFiles/git/ASAssets_GIT_Repo/PDTool/CISAdminApi8.0.0/wsdl/CisAdminApi.wsdl")
public class User
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/MyFiles/git/ASAssets_GIT_Repo/PDTool/CISAdminApi8.0.0/wsdl/CisAdminApi.wsdl");
