...
REM #=======================================================================================
REM # Instructions: 
REM #   script_test_80.bat ENV_TYPE_NAME DEPLOYMENT_PLAN [CUSTOM] [NO_RENAME] [NO_PAUSE]
REM # 
REM # Parameters:
...
set PDTOOL_INSTALL_HOME=%PDTOOL_INSTALL_HOME_TARGET%
...
set VALID_ENV_CONFIG_PAIRS=%VALID_ENV_CONFIG_PAIRS_TARGET%
...
set RELEASE_FOLDER1=%RELEASE_FOLDER1_TARGET%
set RELEASE_FOLDER2=%RELEASE_FOLDER2_TARGET%
