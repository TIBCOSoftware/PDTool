...
echo.    ------------------------------------->>"%DOCUMENTATION%"
echo.     script_test_70.bat and script_test_80.bat parameter definitions:>>"%DOCUMENTATION%"
...
echo.       script_test_80.bat ENV %BusLineBusAreaSubjArea%_1Smoke_gen.dp   ""   ""   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
...
echo.       script_test_80.bat ENV %BusLineBusAreaSubjArea%_1Smoke_gen.dp   TOP  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
echo.       If desired...>>"%DOCUMENTATION%"
...
echo.      script_test_80.bat ENV %BusLineBusAreaSubjArea%_1Smoke_exec.dp   ""  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
...
echo.      script_test_80.bat ENV %BusLineBusAreaSubjArea%_1SmokeAsIs_exec.dp   ""  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
...
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_2Regression_exec.dp   [CUSTOM]  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_2Regression_exec.dp   [CUSTOM]  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
echo.6.  Test 2: Execute Regression Test Compare for ENV - Compare files and logs for difference>>"%DOCUMENTATION%"
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_2Regression_compare.dp   [CUSTOM]  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_2Regression_compare.dp   [CUSTOM]  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
echo.7.  Test 3: Execute Performance Test for ENV>>"%DOCUMENTATION%"
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_3Performance_exec.dp   [CUSTOM]  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_3Performance_exec.dp   [CUSTOM]  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
echo.8.  Test 3: Execute Performance Test Compare for ENV - Compare logs for difference>>"%DOCUMENTATION%"
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_3Performance_compare.dp   [CUSTOM]  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_3Performance_compare.dp   [CUSTOM]  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
echo.9.  Test 4: Generate Security Test for ENV>>"%DOCUMENTATION%"
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_4Security_gen.dp   ""  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_4Security_gen.dp   ""  ""   [PAUSE]>>"%DOCUMENTATION%"
echo.>>"%DOCUMENTATION%"
...
echo.    6.2: script_test_70.bat ENV %BusLineBusAreaSubjArea%_4Security_exec.dp   ""  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
echo.    7.0: script_test_80.bat ENV %BusLineBusAreaSubjArea%_4Security_exec.dp   ""  [RENAME_REL]   [PAUSE]>>"%DOCUMENTATION%"
GOTO:EOF