...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<!-- CIS Path Version 1 -->
	<xsl:variable name="CIS_PATH_PREV_VERSION_1" select="'REPLACE_CIS_PATH_PREV_VERSION_1'"/>
	<xsl:variable name="CIS_PATH_NEW_VERSION_1" select="'REPLACE_CIS_PATH_NEW_VERSION_1'"/>
	<!-- CIS Path Version 2 -->
	<xsl:variable name="CIS_PATH_PREV_VERSION_2" select="'REPLACE_CIS_PATH_PREV_VERSION_2'"/>
	<xsl:variable name="CIS_PATH_NEW_VERSION_2" select="'REPLACE_CIS_PATH_NEW_VERSION_2'"/>
	<!-- CIS Path Version 3 -->
	<xsl:variable name="CIS_PATH_PREV_VERSION_3" select="'REPLACE_CIS_PATH_PREV_VERSION_3'"/>
	<xsl:variable name="CIS_PATH_NEW_VERSION_3" select="'REPLACE_CIS_PATH_NEW_VERSION_3'"/>
	<!-- CIS Path Version 4 -->
	<xsl:variable name="CIS_PATH_PREV_VERSION_4" select="'REPLACE_CIS_PATH_PREV_VERSION_4'"/>
	<xsl:variable name="CIS_PATH_NEW_VERSION_4" select="'REPLACE_CIS_PATH_NEW_VERSION_4'"/>
	<!-- CIS Path Version 5 -->
	<xsl:variable name="CIS_PATH_PREV_VERSION_5" select="'REPLACE_CIS_PATH_PREV_VERSION_5'"/>
	<xsl:variable name="CIS_PATH_NEW_VERSION_5" select="'REPLACE_CIS_PATH_NEW_VERSION_5'"/>
