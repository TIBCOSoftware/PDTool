 ...
 * 
 */
@WebServiceClient(name = "user", targetNamespace = "http://www.compositesw.com/services/system/admin", wsdlLocation = "file:/E:/dev/Workspaces/PDToolGitTest/PDTool7/CISAdminApi62/wsdl/CisAdminApi.wsdl")
public class User
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/dev/Workspaces/PDToolGitTest/PDTool7/CISAdminApi62/wsdl/CisAdminApi.wsdl");
