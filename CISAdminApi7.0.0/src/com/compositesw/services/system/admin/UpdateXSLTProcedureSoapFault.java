...
public class UpdateXSLTProcedureSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public UpdateXSLTProcedureSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public UpdateXSLTProcedureSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
