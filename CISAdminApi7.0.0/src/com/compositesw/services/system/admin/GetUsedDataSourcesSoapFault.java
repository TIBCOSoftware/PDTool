...
public class GetUsedDataSourcesSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public GetUsedDataSourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetUsedDataSourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
