...
public class UpdateUserLockStateSoapFault
    extends Exception
{
     ...
     * @param message
     */
    public UpdateUserLockStateSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public UpdateUserLockStateSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
