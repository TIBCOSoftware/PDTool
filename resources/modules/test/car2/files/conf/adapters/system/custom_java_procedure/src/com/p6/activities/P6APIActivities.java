 ...
 */
public class P6APIActivities
  implements CustomProcedure
{
  private CustomCursor cc = null;
  private P6APIActivitiesConnect p6 = null;
  private ExecutionEnvironment qenv;
  public P6APIActivities() { }
  /**
  ...
  public void initialize(ExecutionEnvironment qenv) {
	  ...
	  this.qenv = qenv;
	  this.qenv.log(LOG_INFO, "P6APIActivities initialized.");

  }
  
  public static void main(String[] args) {
	  
	  P6APIActivities app = new P6APIActivities();
  ...
  public ParameterInfo[] getParameterInfo() {
    return new ParameterInfo[] {
      ...
      new ParameterInfo("result", TYPED_CURSOR, DIRECTION_OUT,
        new ParameterInfo[] {
          new ParameterInfo("ProjectObjectId", Types.INTEGER, DIRECTION_NONE), 
          new ParameterInfo("ProjectId", Types.VARCHAR, DIRECTION_NONE), 
          new ParameterInfo("ActivityId", Types.VARCHAR, DIRECTION_NONE),
          new ParameterInfo("ActivityName", Types.VARCHAR, DIRECTION_NONE),
          new ParameterInfo("StartDate", Types.DATE, DIRECTION_NONE),
          new ParameterInfo("FinishDate", Types.DATE, DIRECTION_NONE),
          new ParameterInfo("Duration", Types.DOUBLE, DIRECTION_NONE),
    ...
    throws CustomProcedureException, SQLException
  {
	  ...
	  p6 = new P6APIActivitiesConnect(username, password, bootstrap);
